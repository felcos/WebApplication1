...
else
{
 ...
 //   app.UseHsts();
    ...
    app.UseDeveloperExceptionPage(); // Temporalmente en producción para depuración
    //app.UseExceptionHandler("/Home/Error"); // Después de depurar, vuelve a habilitar esto.
    app.UseHsts();
